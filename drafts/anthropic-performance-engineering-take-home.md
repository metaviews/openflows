...
### Connections
*   [anthropic-cybersecurity-skills](/currency/currents/anthropic-cybersecurity-skills/): Anthropic engineering artifact. Both entries represent specific technical contributions from Anthropic to the open ecosystem, one focused on agent capabilities and the other on engineering evaluation standards.