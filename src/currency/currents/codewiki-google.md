...
[CodeWiki](https://codewiki.google/) is presented as a public-preview service that auto-generates repository wikis from code, updates those wikis with each commit, and supports chat plus visual diagrams over the codebase.
