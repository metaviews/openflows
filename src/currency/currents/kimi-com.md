...
mediation:
  ...
  use:
    - "capture product surface signals"
...
[Kimi.com](https://www.kimi.com/) now foregrounds K2.5 modes, including Agent Swarm (beta), with visual coding and multi-tool workflows as default interaction patterns.
