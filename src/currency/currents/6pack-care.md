...
mediation:
  ...
  use:
    - "original entry drafted from incorrect signal"
    - "rewritten after refresh identified misclassification"
  humanRole: "full rewrite after verifying source"
  limits: "original entry described a personal health app; actual project is civic AI governance research"
---
